...
public class InstantCloneDetector {
	...
	public static void main(String[] args) {
		try {
			...
			if (useFileList) {
				System.out.println("loading the given file list ...");
				final FileListLoader loader = new FileListLoader();
				paths = loader.loadFileList(inputDir);
			} else {
				System.out.println("detecting target files ...");
			...
			System.out.println("parsing each file ...");
			...
			if (pairWriter != null) {
				...
				System.out.println("\t" + cloneSets.size()
