...
public class GitTargetRevisionDetector extends
	...
	protected Map<String, Date> detectRevisionsAfterTargetCommits(
		...
		/*
		 * please return a sorted map 
		 * whose keys are identifiers of AFTER revisions of commits that added/deleted/changed at least one source file
		 * whose values are dates of the commits
		 */
