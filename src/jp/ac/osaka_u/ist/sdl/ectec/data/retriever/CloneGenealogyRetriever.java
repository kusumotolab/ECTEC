...
public class CloneGenealogyRetriever extends
		RangedElementRetriever<CloneGenealogyInfo> {
	...
	@Override
	protected CloneGenealogyInfo createElement(ResultSet rs)
			throws SQLException {
		int column = 0;
		...
		return new CloneGenealogyInfo(id, startRevisionId, endRevisionId,
